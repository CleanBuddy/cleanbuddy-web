  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <Card className="w-full max-w-2xl">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-bold">Register Your Cleaning Company</CardTitle>
          <CardDescription>Join CleanBuddy as a company partner and manage your team of cleaners</CardDescription>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Upload your company documents. Supported formats: PDF, JPG, PNG (max 10MB each)
                </p>
              </div>
              ...
              <div className="space-y-6">
                <FileUpload
                  ...
                  description="A clear copy of the company representative's government-issued ID"
                  required
                ...
                <FileUpload
                  ...
                  description="Official company registration document from Trade Registry"
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    placeholder="Tell us about your company and why you want to join CleanBuddy..."
                    rows={4}
                  />
                </div>
              </div>
